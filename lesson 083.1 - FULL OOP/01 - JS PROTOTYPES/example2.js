console.log("Practical example2")
// Employee tax rate is 20% if the salary is more the 15L per annum & 30% if salary is more than 20L
...
const emp6 = {
    salary : 2100000,
    empTax(){
        console.log("this emp salasry is > 20L so tax rate is 30%")
    }
}
const emp7 = {
    salary : 2200000,
...
console.log(emp7.empTax)
console.log(emp7.empTax())
// again note that -:
console.log("If object & prototype have same method, object's method will be used")
